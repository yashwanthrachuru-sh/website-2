...
async function run() {
  ...
  const endpoints = [
    ...
    ['GET /api/lessons/1501', '/api/lessons/1501'],
    ['GET /api/lessons/1501/videos', '/api/lessons/1501/videos'],
    ['GET /api/lessons/1501/resources', '/api/lessons/1501/resources'],
    ['GET /api/lessons/1501/exercises', '/api/lessons/1501/exercises'],
    ['GET /api/lessons/1501/quizzes', '/api/lessons/1501/quizzes'],
